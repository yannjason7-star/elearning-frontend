...
function SidebarAdmin() {
  ...
  const navItems = [
    ...
    { label: 'Cours', icon: BookOpen, path: '/admin/cours' },
    { label: 'Apprenants', icon: Users, path: '/admin/apprenants' },
    { label: 'Progression', icon: TrendingUp, path: '/admin/progression' },
    { label: "Temps d'étude", icon: Clock, path: '/admin/temps-etude' },
  ]

  return (
    <div className={`flex flex-col justify-between h-screen sticky top-0 border-r transition-all duration-300 overflow-y-auto
      ${collapsed ? 'w-16' : 'w-56'}
